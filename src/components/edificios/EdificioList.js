...
const podeCriar = temPermissao("criar_edificios");
const podeEditar = temPermissao("editar_edificios");
const podeEliminar = temPermissao("eliminar_edificios");
          ...
          {filtered.map((edificio) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-200/50 mt-auto">
                ...
                <div className="text-blue-600 font-bold text-sm">Detalhes →</div>
              </div>
            </Link>
          ))}
        </div>
