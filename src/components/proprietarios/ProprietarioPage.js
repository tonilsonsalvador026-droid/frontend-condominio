// src/components/proprietarios/ProprietarioPage.js
...
const ProprietarioPage = () => {
  ...
  return (
    <div className="w-full px-4 md:px-8 lg:px-16 xl:px-20">
      {/* === VISUALIZAÇÃO PRINCIPAL (LISTA + BOTÃO NOVO PROPRIETÁRIO) === */}
      {view === "menu" && (
        <div className="space-y-10 mt-10">
          ...
          >
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-800">Novo Proprietário</h2>
              <p className="text-sm text-gray-500">
                Adicionar um novo proprietário ao sistema
              </p>
            </div>
          </div>
      ...
      {view === "form" && (
        <div className="w-full mt-5">
          ...
          <div className="flex items-center mb-6 space-x-3">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Novo Proprietário</h2>
          </div>

          {/* Formulário */}
          <ProprietarioForm onSuccess={() => setView("menu")} />
        </div>
      )}
    </div>
  );
