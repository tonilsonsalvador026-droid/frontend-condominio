// src/components/condominios/CondominioPage.js
      ...
      {view === "menu" && (
        <div className="space-y-10 mt-10">
          ...
          >
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-800">Novo Condomínio</h2>
              <p className="text-sm text-gray-500">
                Adicionar um novo condomínio ao sistema
              </p>
            </div>
          </div>
      ...
      {view === "form" && (
        <div className="w-full mt-5">
          ...
          <div className="flex items-center mb-6 space-x-3">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Novo Condomínio</h2>
          </div>

          {/* Formulário */}
          <CondominioForm onSuccess={() => setView("menu")} />
        </div>
      )}
    </div>
  );
